...
<body>
  ...
  <div class="container">
    <div class="row m-4 border-bottom">
      ...
      <button type="button" class="mx-4 ml-auto btn btn-second btn-lg btn-block">Flat Discount of 30% on all Items</button>
              ...
              <div class="row no-gutters">
                <div class="col-sm-auto" style="text-align:center;">
                  <a href="#" class="pop" style="height: 140px; width:200px;">
                    <img src= "<?php echo $dish[$y]->dish_image ;?>" id="imageresource" class="itemImg img m-2 " alt="" width=100 height=100 /></a>
                </div>
                <div class="col">
