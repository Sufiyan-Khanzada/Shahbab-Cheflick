...
/* Main Footer */
footer .main-footer{  padding: 20px 0;  background: #1C0039;
...
/* Copy Right Footer */
.footer-copyright { background: #1C0039; padding: 5px 0;}
...
.btn{background-color: #9C3DFD; color:#fff;}
...
<footer id="footer" class="footer-1" style="
...
<h5 class="widget-title"><img src="images/footer-logo.png" width="200" height="50"></h5>
...
<div class="widget no-box" style="margin-top:10px;">
...
<li>
<div class="thumb-content"><a href="#.">Cooking Star</a></div> 
</li>
<li>
<div class="thumb-content"><a href="#.">FAQ</a></div> 
</li>
<li>
<div class="thumb-content"><a href="#.">Affiliate Program</a></div>  
</li>
<li>
...
<ul class="thumbnail-widget">
<li>
<div class="thumb-content"><a href="#.">Disclaimer</a></div> 
</li>
<li>
...
<li>
<div class="thumb-content"><a href="#.">Customer Policy</a></div> 
</li>
...
<p><a href="mailto:info@domain.com" title="glorythemes">info@cheflick.com<span></a></p>
<p><a href="mailto:info@domain.com" title="glorythemes">+92 323 1234567</a></p>
...
<p>Copyright Code7labs.com © 2022. All rights reserved.</p>
</div>
</div>
</div>
</div>
